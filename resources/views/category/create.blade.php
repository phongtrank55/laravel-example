...
@section('content')
    ...
    <form action="{{route('category.store')}}" id="form-create" method="POST" class="form-horizontal" >
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <input type="text" name="slug" id="slug" readonly class="form-control" value="{{old('slug')}}">
            </div>
        </div>
